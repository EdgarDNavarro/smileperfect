      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <a href="#doctor" className="text-gray-700 hover:text-blue-600 transition-colors">Dr. La Rosa</a>
            <a href="#smile-perfect" className="text-gray-700 hover:text-blue-600 transition-colors">Smile Perfect</a>
